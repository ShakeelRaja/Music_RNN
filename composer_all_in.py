...
file = "/home/shaks/Desktop/Music_RNN/data/nottingham_all_in.pickle"
if __name__ == '__main__':
    
    np.random.seed()      
    
    parser = argparse.ArgumentParser(description='Script to generated a MIDI file sample from a trained model.')
    parser.add_argument('--config_file', type=str, default = '/home/shaks/Desktop/Music_RNN/models/all_plus_shift1/numLayers_2_hidSize_100_melCoef_0p5_dropOut_0p5_inpDropOut_1_timeBatchLen_128_cellType_LSTMRUN_12_.config')
