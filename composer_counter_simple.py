...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', type=str, default = '/home/shaks/Desktop/Music_RNN/models/counter_grid/numLayers_2_hidSize_150_melCoef_0p5_dropOut_0p5_inpDropOut_1_timeBatchLen_128_cellType_LSTMRUN_15_.config')
    ...
    parser.add_argument('--sample_length', type=int, default=164)
...
#    
        ...
        writer.dump_sequence_to_midi(seq, "models/zzGENERATED/Int_counter/Intcounter.mid", 
